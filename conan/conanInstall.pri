...
!build_pass {
    win32 {
        ...
        conan_install_cmd_params = $$CONAN_INSTALL_PARAMS

        CONAN_QT_VERSION = $$[QT_VERSION]
        conan_install_cmd =  "conan install $$_PRO_FILE_PWD_ -s build_type=$$CONAN_BUILD_TYPE -s arch=$$CONAN_ARCH -s arch_build=$$CONAN_ARCH -o *:qt_version=$$CONAN_QT_VERSION -if $$shadowed($$_PRO_FILE_PWD_) $$conan_install_cmd_params"
